                        ...
                        <div class="form-slider-wrapper form-has-parallax">
                            ...
                            id="infoForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="obs" name='obs' rows="3" cols="30" style="color: black;" placeholder="Olá, gostaria de receber mais informações sobre o Ilha Verde Riviera." required></textarea>
                                </div><!-- /.form-group -->
                                <div class="form-group">
