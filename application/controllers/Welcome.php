...
class Welcome extends CI_Controller {
	...
	public function downloadPlant(){
		...
		$message .="\n https://drive.google.com/open?id=0B-yTn1Lu6L40em9xb1JJbVRPb2c";
		$message .= "\n Agradecemos o contato";

		$insert = array(
			'email'			=>	$this->input->post('email'),
			'plant_link'	=>	"https://drive.google.com/open?id=0B-yTn1Lu6L40em9xb1JJbVRPb2c",
			'data'			=>  date("Y-m-d"),
		);
	...
	public function conversion(){
		?>
			...
			<!-- Google Code for IlhaVerde Conversion Page -->
			...
			var google_conversion_label = "AMbDCMXxrnEQgrf4lwM";
			...
			<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/855513986/?label=AMbDCMXxrnEQgrf4lwM&amp;guid=ON&amp;script=0"/>
			</div>
			</noscript>
